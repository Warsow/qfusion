...
public:
	...
	void set2DScissor( SimulatedBackendState *backendState, int x, int y, int w, int h );

	void enter2DMode( SimulatedBackendState *backendState, int width, int height );
	void leave2DMode( SimulatedBackendState *backendState );
...
private:
	...
	void bindRenderTargetAndViewport( SimulatedBackendState *backendState, RenderTargetComponents *renderTargetComponents, const StateForCamera *stateForCamera );
	...
	void submitDebugStuffToBackend( SimulatedBackendState *backendState, StateForCamera *stateForCamera, Scene *scene );
	...
	void submitRotatedStretchPic( SimulatedBackendState *backendState, int x, int y, int w, int h, float s1, float t1, float s2, float t2,
