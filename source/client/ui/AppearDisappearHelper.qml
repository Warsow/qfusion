...
Item {
    ...
    property int appearDuration: 125
    property int disappearDuration: 80
    ...
    ParallelAnimation {
        id: appearAnim
        NumberAnimation {
            target: root._animTarget
            targets: root._animTargets
            property: "scale"
            from: 0.0; to: 1.0
    ...
    SequentialAnimation {
        ...
        NumberAnimation {
            ...
            property: "opacity"
            from: 0.7; to: 0.0
            duration: root.disappearDuration
    ...
    NumberAnimation {
        ...
        from: 1.0; to: 0.0
        duration: root.disappearDuration
        // The easing is intentionally linear
    }
