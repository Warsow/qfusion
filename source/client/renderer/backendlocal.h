...
public:
	...
	void bindShader( const entity_t *e, const ShaderParams *overrideParams, const ShaderParamsTable *paramsTable, const shader_s *shader, const mfog_s *fog, const struct portalSurface_s *portalSurface );
...
private:
	...
	void setupProgram( int type, const shader_s *materialToGetDeforms, uint64_t features );
	...
	void renderMeshUsingQ3AProgram( const FrontendToBackendShared *, const DrawMeshVertSpan *vertSpan, int primitive, const shaderpass_t *pass, uint64_t programFeatures );
	void renderMeshUsingMaterialProgram( const FrontendToBackendShared *, const DrawMeshVertSpan *vertSpan, int primitive, const shaderpass_t *pass, uint64_t programFeatures );
	void renderMeshUsingOutlineProgram( const FrontendToBackendShared *, const DrawMeshVertSpan *vertSpan, int primitive, const shaderpass_t *pass, uint64_t programFeatures );
	void renderMeshUsingCelshadeProgram( const FrontendToBackendShared *, const DrawMeshVertSpan *vertSpan, int primitive, const shaderpass_t *pass, uint64_t programFeatures );
	void renderMeshUsingDistortionProgram( const FrontendToBackendShared *, const DrawMeshVertSpan *vertSpan, int primitive, const shaderpass_t *pass, uint64_t programFeatures );
	void renderMeshUsingFogProgram( const FrontendToBackendShared *, const DrawMeshVertSpan *vertSpan, int primitive, const shaderpass_t *pass, uint64_t programFeatures );
	void renderMeshUsingYuvProgram( const FrontendToBackendShared *, const DrawMeshVertSpan *vertSpan, int primitive, const shaderpass_t *pass, uint64_t programFeatures );
	void renderMeshUsingFxaaProgram( const FrontendToBackendShared *, const DrawMeshVertSpan *vertSpan, int primitive, const shaderpass_t *pass, uint64_t programFeatures );
	void renderMeshUsingColorCorrectionProgram( const FrontendToBackendShared *, const DrawMeshVertSpan *vertSpan, int primitive, const shaderpass_t *pass, uint64_t programFeatures );
	void renderMeshUsingKawaseProgram( const FrontendToBackendShared *, const DrawMeshVertSpan *vertSpan, int primitive, const shaderpass_t *pass, uint64_t programFeatures );

	void renderMeshUsingAppropriateProgram( const FrontendToBackendShared *fsh, const DrawMeshVertSpan *vertSpan, int primitive, const shaderpass_t *pass, unsigned programType );
