...
private:
	...
	wsw::StaticVector<uint16_t, kMaxClassTriggerEnts> m_allElevatorTriggers;
...
public:
	...
	[[nodiscard]]
	auto getAllPersistentMapElevatorTriggers() const -> std::span<const uint16_t> {
		return { m_allElevatorTriggers.begin(), m_allElevatorTriggers.end() };
	}
	[[nodiscard]]
